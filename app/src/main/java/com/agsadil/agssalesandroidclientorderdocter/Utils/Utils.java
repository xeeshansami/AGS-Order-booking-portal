...
public class Utils implements IOnConnectionTimeoutListener {
    ...
    public void loginOrActiveCheck(boolean isSalesman, boolean isCustomer, boolean isSPO, final Button button, final String username, final String pwd,boolean isCheckedRemember) {
...
//                    sp.clearAll();
    ...
    public void setUpDownloadAlertBox(final Button button) {
        ...
        subProgress.setProgressTintList(ColorStateList.valueOf(Color.RED));
...
//                                }
    ...
    public String getURLForResource2(int resourceId) {
        Uri path = Uri.parse("android.resource:// com.agsadil.agssalesandroidclientorderdocter/" + R.drawable.icon);
