package com.agsadil.agssalesandroidclientorderdocter.Database;
...
import com.agsadil.agssalesandroidclientorderdocter.Models.User;
...
//                    singleOrder.setOrderAddress(cursor.getString(17));
    ...
    public ArrayList<EntityOrder> getAllCustomer() {
        ...
        String helloWorld = "SELECT * FROM order_list GROUP BY orderCustName HAVING COUNT(orderCustName) > 0";
