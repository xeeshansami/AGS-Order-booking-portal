...
import com.ags.agssalesandroidclientorderdocter.Activities.DashboardActivity;
import com.ags.agssalesandroidclientorderdocter.Activities.LoginActivity;
...
public class Utils implements IOnConnectionTimeoutListener {
    ...
    public String getURLForResource2(int resourceId) {
        Uri path = Uri.parse("android.resource:// com.ags.agssalesandroidclientorderdocter/" + R.drawable.icon);
