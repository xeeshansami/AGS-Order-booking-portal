...
public class ProductOfferListAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<EntityProduct> productItems;

    public ProductOfferListAdapter(Activity activity, List<EntityProduct> productItems){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.layout_productoffer_row, null);
